...
import "../src/TimeShiftLib.sol";

contract TimeShiftLibShiftTest is TribeTest {
    ...
    function testGasWorstCase() public {
        ...
        assertLt(initialGas - gasleft(), 12_000);
    }
...
contract TimeShiftLibEncodingTest is TribeTest {
    using TimeShiftLib for *;
...
contract TimeShiftLibHelpersTest is TribeTest {
    using TimeShiftLib for *;
